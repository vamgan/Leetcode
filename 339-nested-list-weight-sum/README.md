<h2><a href="https://leetcode.com/problems/nested-list-weight-sum/">339. Nested List Weight Sum</a></h2><h3>Medium</h3><hr><div bis_skin_checked="1"><p>You are given a nested list of integers <code>nestedList</code>. Each element is either an integer or a list whose elements may also be integers or other lists.</p>
